...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch {
    if ([touch.view isKindOfClass:[UISlider class]] || [touch.view isKindOfClass:[iCarousel class]]) {
...
- (void) openContentViewControllerForSports : (id) sender
{
    dispatch_async(dispatch_get_main_queue(), ^{
        NSString *identifier = @"sports";
        [self.leftMenu performSegueWithIdentifier:identifier sender:self.leftMenu];
    });
}

-(void) openContentControllerInHome
{
    dispatch_async(dispatch_get_main_queue(), ^{
