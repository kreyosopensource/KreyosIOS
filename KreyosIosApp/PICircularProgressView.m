...
+ (void)initialize
{
    if (self == [PICircularProgressView class])
    {
        ...
        [appearance setProgressBottomGradientColor:[UIColor colorWithRed:236/255.0 green:69/255.0 blue:183/255.0 alpha:1.0]];
        [appearance setProgressTopGradientColor:[UIColor colorWithRed:183/255.0 green:228/255.0 blue:65/255.0 alpha:1.0]];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (_showText && _textColor)
    {
        ...
        CGPoint origin = CGPointMake(center.x - expectedSize.width / 2.0, center.y - expectedSize.height * 1.5f);
